...
public class JSONValue {
	 ...
	 */
	public static Object parseWithException(Reader in) throws 
                IOException, 
                ParseException{
		JSONParser parser=new JSONParser();
		return parser.parse(in);
	...
	public static void writeJSONString(Object value, Writer out) throws 
		...
		if(value instanceof Double){
			if(((Double)value).isInfinite() || ((Double)value)
                                .isNaN())
				out.write("null");
			else
		...
		if(value instanceof Float){
			if(((Float)value).isInfinite() || ((Float)value)
                                .isNaN())
				out.write("null");
			else
				out.write(value.toString());
	 ...
	 * DO NOT call this method from toJSONString() of a class that 
         * implements both JSONAware and Map or List with 
